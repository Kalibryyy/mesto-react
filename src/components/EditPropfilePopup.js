...
function EditProfilePopup(props) {
    ...
    const [name, setName] = React.useState('Елена Стрижакова');
    const [description, setDescription] = React.useState('Начинающий веб-разработчик и опытный моряк-путешественник');
